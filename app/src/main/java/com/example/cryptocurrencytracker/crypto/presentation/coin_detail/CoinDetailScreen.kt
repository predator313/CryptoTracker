package com.example.cryptocurrencytracker.crypto.presentation.coin_detail
...
import com.example.cryptocurrencytracker.crypto.presentation.coin_detail.components.InfoCard
import com.example.cryptocurrencytracker.crypto.presentation.coin_list.CoinListEvents
...
import com.example.cryptocurrencytracker.crypto.presentation.model.toDisplayableNumber
import com.example.cryptocurrencytracker.ui.theme.CryptoCurrencyTrackerTheme
import com.example.cryptocurrencytracker.ui.theme.greenBackground
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            FlowRow(
                ...
                val absoluteFormatted = (coin.priceUsd.value*(coin.changePercentage24Hr.value/100))
                    .toDisplayableNumber()
                ...
                InfoCard(
                    ...
                    formattedText = absoluteFormatted.formatted,
